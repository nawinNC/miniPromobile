...
class Teeloshu extends StatelessWidget {
  const Teeloshu({Key? key}) : super(key: key);
          ...
          Column(
            children: [
              const Padding(
                ...
                child: Image(
                  image: AssetImage('assets/images/teeloshu.jpg'),
                ),
              ),
              Row(
                children: [
                          ...
                          child: Column(
                            children:  [
                              ...
                              Padding(
                                  ...
                                  child: IconButton(
                                      onPressed: () {
                                        Navigator.pushNamed(context, '/myMapstlo');
                                      },
